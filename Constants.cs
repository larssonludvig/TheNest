public class Constants {
    ...
    public List<string> LWeapons = new List<string> {"V9S", "93R", "M11", "XP-54", "SH1900", "LH1", "SR-84", "Dagger", "Sword", "Throwing_Knives", "Recursive_Bow"};
    ...
    public List<string> MWeapons = new List<string> {"AKM", "FCAR", "CL-40", "R.357", "Model_1887", "Riot_Shield", "FAMAS", "Dual_Katanas"};
